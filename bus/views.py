...
from .forms import NewImageForm, UpdatebioForm, ReviewForm, NewProjectForm,NewsLetterForm,Profile
...
def home(request):
    ...
    if request.GET.get('search_term'):
        project = Project.search_project(request.GET.get('search_term'))
...
def individual_profile_page(request, username=None):
    ...
    return render (request, 'registration/users_image.html', {'images':images, 'username': username})
...
def individual_profile_page(request, username):
    ...
    if userf:
        ...
        print('No suchuser')
    return render (request, 'registration/users_image.html', context, {'images':images,
                                                                  'profile':profile,
                                                                  'user':user,
                                                                  'username': username})
